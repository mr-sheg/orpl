...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.verticalLayout_12 = QtWidgets.QVBoxLayout(self.tabProcessing)
        ...
        self.page.setGeometry(QtCore.QRect(0, 0, 129, 237))
        ...
        self.horizontalLayout_2.addWidget(self.boxRawSignal)
        self.boxIRFCorrection = QtWidgets.QGroupBox(self.tabProcessing)
        self.boxIRFCorrection.setObjectName("boxIRFCorrection")
        self.horizontalLayout_2.addWidget(self.boxIRFCorrection)
        self.verticalLayout_11.addLayout(self.horizontalLayout_2)
        self.horizontalLayout_15 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_15.setObjectName("horizontalLayout_15")
        self.boxBaselineFit = QtWidgets.QGroupBox(self.tabProcessing)
        self.boxBaselineFit.setObjectName("boxBaselineFit")
        self.horizontalLayout_15.addWidget(self.boxBaselineFit)
        self.boxProcessedSignal = QtWidgets.QGroupBox(self.tabProcessing)
        self.boxProcessedSignal.setObjectName("boxProcessedSignal")
        self.horizontalLayout_15.addWidget(self.boxProcessedSignal)
        ...
        self.groupBox_5 = QtWidgets.QGroupBox(self.tabProcessing)
        ...
        self.textEditExportDir = QtWidgets.QLineEdit(self.groupBox_5)
        self.textEditExportDir.setReadOnly(True)
        self.textEditExportDir.setObjectName("textEditExportDir")
        self.horizontalLayout_17.addWidget(self.textEditExportDir)
        self.buttonSelectExportDir = QtWidgets.QPushButton(self.groupBox_5)
        self.buttonSelectExportDir.setObjectName("buttonSelectExportDir")
        self.horizontalLayout_17.addWidget(self.buttonSelectExportDir)
        self.buttonExportData = QtWidgets.QPushButton(self.groupBox_5)
        self.buttonExportData.setObjectName("buttonExportData")
        self.horizontalLayout_17.addWidget(self.buttonExportData)
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.boxIRFCorrection.setTitle(_translate("mainWindow", "After System Correction"))
        self.boxBaselineFit.setTitle(_translate("mainWindow", "Baseline Fits"))
        self.boxProcessedSignal.setTitle(_translate("mainWindow", "Raman Spectra"))
        self.groupBox_5.setTitle(_translate("mainWindow", "Export Data"))
        self.label_14.setText(_translate("mainWindow", "Export Directory"))
        self.buttonSelectExportDir.setText(_translate("mainWindow", "Select Directory"))
        self.buttonExportData.setText(_translate("mainWindow", "Export Data"))
